...
>(({ 
  ...
  const variantClasses = {
    default: "bg-background text-foreground border-2 border-border hover:border-blue-00",
    outline: "border-2 border-border bg-transparent text-foreground ",
    ghost: "bg-transparent text-foreground hover:bg-background border-2 border-transparent hover:border-blue-500"
  };
